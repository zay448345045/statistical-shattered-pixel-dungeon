...
public class DwarfKingHard extends Boss{
    {
    ...
    private boolean summonSubject( int delay, Class<?extends Mob> type ){
        ...
        s.pos = ((HardDKLevel)Dungeon.level).getSummoningPos();
    ...
    public void damage(int dmg, Object src) {
        ...
        if (phase == 1) {
            ...
            if (HP <= 120) {
                ...
                ScrollOfTeleportation.appear(this, HardDKLevel.throne);
    ...
    public static class DeathRattleSummon extends Buff{
        ...
        public Mob idToMob(){
            switch (summonCate){
                ...
                case 2: default: return Reflection.newInstance(DKMonk.class);
            }
        }
    ...
    public static class StrengthEmpower extends FlavourBuff{
        ...
        public boolean attachTo(Char target){
            target.sprite.showStatus(0x00FF00, Messages.get(DwarfKingHard.class, "str_empower"));
