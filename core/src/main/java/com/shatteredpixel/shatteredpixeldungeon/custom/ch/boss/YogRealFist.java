...
public abstract class YogRealFist extends Mob {
    ...
    protected boolean isNearYog(){
        int yogPos = YogRealLevel.CENTER;
    ...
    public static class BurningFist extends YogRealFist {
    ...
    public static class RottingFist extends YogRealFist {
    ...
    public static class RustedFist extends YogRealFist {
    ...
    public static class BrightFist extends YogRealFist {
    ...
    public static class DarkFist extends YogRealFist {
