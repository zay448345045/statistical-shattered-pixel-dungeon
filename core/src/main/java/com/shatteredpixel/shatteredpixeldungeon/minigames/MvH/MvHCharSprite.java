...
public class MvHCharSprite extends CharSprite implements Tweener.Listener, MovieClip.Listener {
    ...
    public boolean gameMvH = false;
    public boolean gameHungry = false;
    ...
    private static class JumpTweener extends Tweener {
        ...
        public JumpTweener( MvHCharSprite visual, PointF pos, float height, float time ) {
            super( visual, time );
